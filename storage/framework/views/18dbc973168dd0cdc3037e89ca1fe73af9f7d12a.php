    ...
    <section class="method-payment py-2 pt-5">
        <div class="container mt-5 mb-5 d-flex justify-content-center">
            <div class="card p-5">
                ...
                <p class="mb-0 mt-3 fs-5"><strong>Total pembayaran : </strong> Rp <?php echo e(number_format($cart->total_cost)); ?></p>
                <div class="mt-5"> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BagUp\totebag\resources\views/payments.blade.php ENDPATH**/ ?>