...
<body>
    <section class="method-payment py-2 mt-5 pt-5">
        <div class="container mt-5 mb-5 d-flex justify-content-center">
            <div class="card p-5">
                ...
                <div class="credit rounded mt-4 d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row align-items-center"> <img src="<?php echo e(asset('asset/img/dana.png')); ?>"
                ...
                <div class="credit rounded mt-2 d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row align-items-center"> <img src="<?php echo e(asset('asset/img/shopee.svg')); ?>"
                ...
                <p class="mb-0 mt-3 fs-5"><strong>Total pembayaran : </strong> Rp <?php echo e(number_format($order->material->harga * $order->quantity)); ?></p>
                <div class="mt-5"> 
                <button class="btn btn-primary btn-block payment-button"><a href="<?php echo e(url('/confirm')); ?>"
                            class="text-light text-decoration-none">Konfirmasi Pembayaran <i
                                class="fa fa-long-arrow-right"></i></a></button>
                    <button class="btn btn-danger btn-block payment-button mx-2"><a href="<?php echo e(url('home')); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\BagUp\totebag\resources\views/payment.blade.php ENDPATH**/ ?>